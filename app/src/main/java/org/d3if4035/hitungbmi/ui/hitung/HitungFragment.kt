...
import org.d3if4035.hitungbmi.R
import org.d3if4035.hitungbmi.data.KategoriBmi
import org.d3if4035.hitungbmi.databinding.FragmentHitungBinding
import org.d3if4035.hitungbmi.db.BmiDb
...
class HitungFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getHasilBmi().observe(viewLifecycleOwner, {
            if (it == null) return@observe
            binding.hasilBmi.text = getString(R.string.bmi_x, it.bmi)
            binding.kategoriBmi.text = getString(R.string.kategori_x, getKategori(it.kategori))
